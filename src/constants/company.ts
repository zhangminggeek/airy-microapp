...
export const paymentTypeMap = new Map([
  ...
  [PaymentType['微信'], { text: '微信支付', value: PaymentType['微信'] }],
]);
...
export const balanceRecordTypeMap = new Map([
  ...
  [
    BalanceRecordType['邀请注册奖励'],
    { text: '邀请注册奖励', value: BalanceRecordType['邀请注册奖励'] },
  ],
  [
    BalanceRecordType['支付金额返还'],
    { text: '支付金额返还', value: BalanceRecordType['支付金额返还'] },
  ],
  [
    BalanceRecordType['活动奖励'],
    { text: '活动奖励', value: BalanceRecordType['活动奖励'] },
  ],
]);
