...
export enum ProductFiledKey {
  ...
  '礼服-形状' = `${ProductType['礼服']}_geometria`,
...
export enum ProductFiledOption {
  '婚纱-材质-缎面' = `${ProductFiledKey['婚纱-材质']}_a`,
  '婚纱-材质-蕾丝' = `${ProductFiledKey['婚纱-材质']}_b`,
  '婚纱-材质-纱面' = `${ProductFiledKey['婚纱-材质']}_c`,
  '婚纱-材质-纱缎结合' = `${ProductFiledKey['婚纱-材质']}_d`,
  '婚纱-材质-其他' = `${ProductFiledKey['婚纱-材质']}_e`,
  '婚纱-形状-A字裙' = `${ProductFiledKey['婚纱-形状']}_a`,
  '婚纱-形状-鱼尾' = `${ProductFiledKey['婚纱-形状']}_b`,
  '婚纱-形状-公主裙' = `${ProductFiledKey['婚纱-形状']}_c`,
  '婚纱-形状-直筒型' = `${ProductFiledKey['婚纱-形状']}_d`,
  '婚纱-形状-修身型' = `${ProductFiledKey['婚纱-形状']}_e`,
  '婚纱-领口-V领' = `${ProductFiledKey['婚纱-领口']}_a`,
  '婚纱-领口-心型' = `${ProductFiledKey['婚纱-领口']}_b`,
  '婚纱-领口-包肩式' = `${ProductFiledKey['婚纱-领口']}_c`,
  '婚纱-领口-抹胸' = `${ProductFiledKey['婚纱-领口']}_d`,
  '婚纱-领口-一字肩' = `${ProductFiledKey['婚纱-领口']}_e`,
  '婚纱-领口-挂脖式' = `${ProductFiledKey['婚纱-领口']}_f`,
  '婚纱-领口-圆领' = `${ProductFiledKey['婚纱-领口']}_g`,
  '婚纱-袖子-长袖' = `${ProductFiledKey['婚纱-袖子']}_a`,
  '婚纱-袖子-短袖' = `${ProductFiledKey['婚纱-袖子']}_b`,
  '婚纱-袖子-无袖' = `${ProductFiledKey['婚纱-袖子']}_c`,
  '婚纱-袖子-泡泡袖' = `${ProductFiledKey['婚纱-袖子']}_d`,
  '婚纱-颜色-白色' = `${ProductFiledKey['婚纱-颜色']}_a`,
  '婚纱-颜色-粉色' = `${ProductFiledKey['婚纱-颜色']}_b`,
  '婚纱-颜色-香槟色' = `${ProductFiledKey['婚纱-颜色']}_c`,
  '婚纱-颜色-银色' = `${ProductFiledKey['婚纱-颜色']}_d`,
  '婚纱-颜色-红色' = `${ProductFiledKey['婚纱-颜色']}_e`,
  '婚纱-颜色-其他' = `${ProductFiledKey['婚纱-颜色']}_z`,
  '婚纱-拖尾-长拖尾' = `${ProductFiledKey['婚纱-拖尾']}_a`,
  '婚纱-拖尾-短拖尾' = `${ProductFiledKey['婚纱-拖尾']}_b`,
  '婚纱-拖尾-齐地' = `${ProductFiledKey['婚纱-拖尾']}_c`,
  '礼服-材质-缎面' = `${ProductFiledKey['礼服-材质']}_a`,
  '礼服-材质-纺面' = `${ProductFiledKey['礼服-材质']}_b`,
  '礼服-材质-蕾丝' = `${ProductFiledKey['礼服-材质']}_c`,
  '礼服-材质-纱面' = `${ProductFiledKey['礼服-材质']}_d`,
  '礼服-材质-真丝' = `${ProductFiledKey['礼服-材质']}_e`,
  '礼服-材质-丝绒' = `${ProductFiledKey['礼服-材质']}_f`,
  '礼服-形状-A字型' = `${ProductFiledKey['礼服-形状']}_a`,
  '礼服-形状-鱼尾' = `${ProductFiledKey['礼服-形状']}_b`,
  '礼服-形状-公主型' = `${ProductFiledKey['礼服-形状']}_c`,
  '礼服-领口-V领' = `${ProductFiledKey['礼服-领口']}_a`,
  '礼服-领口-心型' = `${ProductFiledKey['礼服-领口']}_b`,
  '礼服-领口-包肩式' = `${ProductFiledKey['礼服-领口']}_c`,
  '礼服-领口-抹胸' = `${ProductFiledKey['礼服-领口']}_d`,
  '礼服-领口-一字肩' = `${ProductFiledKey['礼服-领口']}_e`,
  '礼服-领口-挂脖式' = `${ProductFiledKey['礼服-领口']}_f`,
  '礼服-领口-圆领' = `${ProductFiledKey['礼服-领口']}_g`,
  '礼服-袖子-长袖' = `${ProductFiledKey['礼服-袖子']}_a`,
  '礼服-袖子-短袖' = `${ProductFiledKey['礼服-袖子']}_b`,
  '礼服-袖子-无袖' = `${ProductFiledKey['礼服-袖子']}_c`,
  '礼服-颜色-红色' = `${ProductFiledKey['礼服-颜色']}_a`,
  '礼服-颜色-粉色' = `${ProductFiledKey['礼服-颜色']}_b`,
  '礼服-颜色-白色' = `${ProductFiledKey['礼服-颜色']}_c`,
  '礼服-颜色-黄色' = `${ProductFiledKey['礼服-颜色']}_d`,
  '礼服-颜色-橙色' = `${ProductFiledKey['礼服-颜色']}_e`,
  '礼服-颜色-绿色' = `${ProductFiledKey['礼服-颜色']}_f`,
  '礼服-颜色-蓝色' = `${ProductFiledKey['礼服-颜色']}_g`,
  '礼服-颜色-紫色' = `${ProductFiledKey['礼服-颜色']}_h`,
  '礼服-颜色-黑色' = `${ProductFiledKey['礼服-颜色']}_i`,
  '礼服-颜色-灰色' = `${ProductFiledKey['礼服-颜色']}_j`,
  '礼服-颜色-彩虹' = `${ProductFiledKey['礼服-颜色']}_k`,
  '礼服-颜色-香槟色' = `${ProductFiledKey['礼服-颜色']}_l`,
  '礼服-颜色-银色' = `${ProductFiledKey['礼服-颜色']}_m`,
  '礼服-颜色-其他' = `${ProductFiledKey['礼服-颜色']}_z`,
  '秀禾-类别-男' = `${ProductFiledKey['秀禾-类别']}_a`,
  '秀禾-类别-女' = `${ProductFiledKey['秀禾-类别']}_b`,
  '秀禾-材质-丝绸' = `${ProductFiledKey['秀禾-材质']}_a`,
  '秀禾-材质-真丝' = `${ProductFiledKey['秀禾-材质']}_b`,
  '秀禾-款式-龙凤褂' = `${ProductFiledKey['秀禾-款式']}_a`,
  '秀禾-款式-秀禾' = `${ProductFiledKey['秀禾-款式']}_b`,
  '秀禾-款式-汉服' = `${ProductFiledKey['秀禾-款式']}_c`,
  '秀禾-款式-明制汉服' = `${ProductFiledKey['秀禾-款式']}_d`,
  '秀禾-款式-改良汉服' = `${ProductFiledKey['秀禾-款式']}_e`,
  '秀禾-裙摆-A摆' = `${ProductFiledKey['秀禾-裙摆']}_a`,
  '秀禾-裙摆-太阳摆' = `${ProductFiledKey['秀禾-裙摆']}_b`,
  '秀禾-颜色-红色' = `${ProductFiledKey['秀禾-颜色']}_a`,
  '秀禾-颜色-金色' = `${ProductFiledKey['秀禾-颜色']}_b`,
  '秀禾-颜色-粉色' = `${ProductFiledKey['秀禾-颜色']}_c`,
  '秀禾-颜色-蓝色' = `${ProductFiledKey['秀禾-颜色']}_d`,
  '秀禾-颜色-香槟色' = `${ProductFiledKey['秀禾-颜色']}_e`,
  '秀禾-颜色-银色' = `${ProductFiledKey['秀禾-颜色']}_f`,
  '秀禾-颜色-其他' = `${ProductFiledKey['秀禾-颜色']}_z`,
  '西服-材质-羊毛' = `${ProductFiledKey['西服-材质']}_a`,
  '西服-材质-亚麻' = `${ProductFiledKey['西服-材质']}_b`,
  '西服-材质-纯棉' = `${ProductFiledKey['西服-材质']}_c`,
  '西服-颜色-黑色系' = `${ProductFiledKey['西服-颜色']}_a`,
  '西服-颜色-灰色系' = `${ProductFiledKey['西服-颜色']}_b`,
  '西服-颜色-红色系' = `${ProductFiledKey['西服-颜色']}_c`,
  '西服-颜色-橙色系' = `${ProductFiledKey['西服-颜色']}_d`,
  '西服-颜色-蓝色系' = `${ProductFiledKey['西服-颜色']}_e`,
  '西服-颜色-黄色系' = `${ProductFiledKey['西服-颜色']}_f`,
  '西服-颜色-绿色系' = `${ProductFiledKey['西服-颜色']}_g`,
  '西服-颜色-紫色系' = `${ProductFiledKey['西服-颜色']}_h`,
  '西服-颜色-其他' = `${ProductFiledKey['西服-颜色']}_i`,
  '伴娘服-材质-缎面' = `${ProductFiledKey['伴娘服-材质']}_a`,
  '伴娘服-材质-纺面' = `${ProductFiledKey['伴娘服-材质']}_b`,
  '伴娘服-材质-蕾丝' = `${ProductFiledKey['伴娘服-材质']}_c`,
  '伴娘服-材质-纱面' = `${ProductFiledKey['伴娘服-材质']}_d`,
  '伴娘服-材质-真丝' = `${ProductFiledKey['伴娘服-材质']}_e`,
  '伴娘服-袖子-长袖' = `${ProductFiledKey['伴娘服-袖子']}_a`,
  '伴娘服-袖子-短袖' = `${ProductFiledKey['伴娘服-袖子']}_b`,
  '伴娘服-袖子-无袖' = `${ProductFiledKey['伴娘服-袖子']}_c`,
  '伴娘服-颜色-红色' = `${ProductFiledKey['伴娘服-颜色']}_a`,
  '伴娘服-颜色-粉色' = `${ProductFiledKey['伴娘服-颜色']}_b`,
  '伴娘服-颜色-黄色' = `${ProductFiledKey['伴娘服-颜色']}_c`,
  '伴娘服-颜色-橙色' = `${ProductFiledKey['伴娘服-颜色']}_d`,
  '伴娘服-颜色-绿色' = `${ProductFiledKey['伴娘服-颜色']}_e`,
  '伴娘服-颜色-蓝色' = `${ProductFiledKey['伴娘服-颜色']}_f`,
  '伴娘服-颜色-紫色' = `${ProductFiledKey['伴娘服-颜色']}_g`,
  '伴娘服-颜色-黑色' = `${ProductFiledKey['伴娘服-颜色']}_h`,
  '伴娘服-颜色-灰色' = `${ProductFiledKey['伴娘服-颜色']}_i`,
  '伴娘服-颜色-白色' = `${ProductFiledKey['伴娘服-颜色']}_j`,
  '伴娘服-颜色-彩虹' = `${ProductFiledKey['伴娘服-颜色']}_k`,
  '伴娘服-颜色-香槟色' = `${ProductFiledKey['伴娘服-颜色']}_l`,
  '伴娘服-颜色-银色' = `${ProductFiledKey['伴娘服-颜色']}_m`,
  '伴娘服-颜色-其他' = `${ProductFiledKey['伴娘服-颜色']}_z`,
}
      ...
      [
        ProductFiledKey['婚纱-袖子'],
        {
          ...
          options: [
            ...
            { text: '泡泡袖', value: ProductFiledOption['婚纱-袖子-泡泡袖'] },
          ],
        },
      ],
      [
        ProductFiledKey['婚纱-颜色'],
        {
          ...
          options: [
            ...
            { text: '香槟色', value: ProductFiledOption['婚纱-颜色-香槟色'] },
            { text: '银色', value: ProductFiledOption['婚纱-颜色-银色'] },
            { text: '红色', value: ProductFiledOption['婚纱-颜色-红色'] },
      ...
      [
        ProductFiledKey['礼服-材质'],
        {
          ...
          options: [
            ...
            { text: '丝绒', value: ProductFiledOption['礼服-材质-丝绒'] },
          ],
        },
      ],
      [
        ProductFiledKey['礼服-形状'],
        {
          name: '形状',
          options: [
            { text: 'A字型', value: ProductFiledOption['礼服-形状-A字型'] },
            { text: '鱼尾', value: ProductFiledOption['礼服-形状-鱼尾'] },
            { text: '公主型', value: ProductFiledOption['礼服-形状-公主型'] },
          ],
        },
      ],
      [
      ...
      [
        ProductFiledKey['礼服-颜色'],
        {
          ...
          options: [
            ...
            { text: '香槟色', value: ProductFiledOption['礼服-颜色-香槟色'] },
            { text: '银色', value: ProductFiledOption['礼服-颜色-银色'] },
      ...
      [
        ProductFiledKey['秀禾-材质'],
        {
          ...
          options: [
            ...
            { text: '真丝', value: ProductFiledOption['秀禾-材质-真丝'] },
          ],
        },
      ],
      [
      ...
      [
        ProductFiledKey['伴娘服-颜色'],
        {
          ...
          options: [
            ...
            { text: '香槟色', value: ProductFiledOption['伴娘服-颜色-香槟色'] },
            { text: '银色', value: ProductFiledOption['伴娘服-颜色-银色'] },
