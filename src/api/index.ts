...
export interface GetGetewayWsSignRequest {}

export type GetGetewayWsSignResponse = string

type GetGetewayWsSignRequestConfig = Readonly<
  RequestConfig<'http://127.0.0.1:50505/mock/0', '', '', '/geteway/ws/sign', 'data', string, string, true>
>

const getGetewayWsSignRequestConfig: GetGetewayWsSignRequestConfig = /*#__PURE__*/ {
  mockUrl: mockUrl_0_0_0_0,
  devUrl: devUrl_0_0_0_0,
  prodUrl: prodUrl_0_0_0_0,
  path: '/geteway/ws/sign',
  method: Method.GET,
  requestHeaders: {},
  ...
  requestFunctionName: 'getGetewayWsSign',
  queryStringArrayFormat: QueryStringArrayFormat.brackets,
  extraInfo: {},
}

export const getGetewayWsSign = /*#__PURE__*/ (requestData?: GetGetewayWsSignRequest, ...args: UserRequestRestArgs) => {
  return request<GetGetewayWsSignResponse>(prepare(getGetewayWsSignRequestConfig, requestData), ...args)
}

getGetewayWsSign.requestConfig = getGetewayWsSignRequestConfig
...
export interface GetChatMessageWithPageRequest {
  /**
   * 对话id
   */
  chatId: string
...
export interface GetChatMessageWithPageResponse {
  /**
   * 数据总条数
   */
  total: number
...
type GetChatMessageWithPageRequestConfig = Readonly<
  RequestConfig<
    'http://127.0.0.1:50505/mock/0',
    '',
    '',
    '/chat/message/with/page',
    'data',
    string,
...
const getChatMessageWithPageRequestConfig: GetChatMessageWithPageRequestConfig = /*#__PURE__*/ {
  mockUrl: mockUrl_0_0_0_10,
  devUrl: devUrl_0_0_0_10,
  prodUrl: prodUrl_0_0_0_10,
  path: '/chat/message/with/page',
  method: Method.GET,
  requestHeaders: {},
  requestBodyType: RequestBodyType.query,
  responseBodyType: ResponseBodyType.json,
  ...
  paramNames: [],
  queryNames: ['chatId', 'latestMessageId'],
  requestDataOptional: false,
  requestDataJsonSchema: {},
  responseDataJsonSchema: {},
  requestFunctionName: 'getChatMessageWithPage',
  queryStringArrayFormat: QueryStringArrayFormat.brackets,
  extraInfo: {},
}

export const getChatMessageWithPage = /*#__PURE__*/ (
  requestData: GetChatMessageWithPageRequest,
  ...args: UserRequestRestArgs
) => {
  return request<GetChatMessageWithPageResponse>(prepare(getChatMessageWithPageRequestConfig, requestData), ...args)
}

getChatMessageWithPage.requestConfig = getChatMessageWithPageRequestConfig
...
export type PostChatMessageResponse = number

type PostChatMessageRequestConfig = Readonly<
  RequestConfig<'http://127.0.0.1:50505/mock/0', '', '', '/chat/message', 'data', string, string, false>
>

const postChatMessageRequestConfig: PostChatMessageRequestConfig = /*#__PURE__*/ {
  mockUrl: mockUrl_0_0_0_10,
  devUrl: devUrl_0_0_0_10,
  prodUrl: prodUrl_0_0_0_10,
  path: '/chat/message',
  ...
  requestDataJsonSchema: {},
  responseDataJsonSchema: {},
  requestFunctionName: 'postChatMessage',
  queryStringArrayFormat: QueryStringArrayFormat.brackets,
  extraInfo: {},
}

export const postChatMessage = /*#__PURE__*/ (requestData: PostChatMessageRequest, ...args: UserRequestRestArgs) => {
  return request<PostChatMessageResponse>(prepare(postChatMessageRequestConfig, requestData), ...args)
}
